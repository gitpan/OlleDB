#---------------------------------------------------------------------
# $Header: /Perl/OlleDB/t/9_loginproperties.t 13    05-11-06 20:48 Sommar $
#
...
$testc->sql("RAISERROR('Testing OlleDB', 20, 1) WITH LOG");
if (not $testc->isconnected()) {
   print "ok 29\n";
}
else {
